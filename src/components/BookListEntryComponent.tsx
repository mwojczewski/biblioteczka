...
export function BookListEntryComponent(book:RawBook)
{
    ...
    const {setMessages, openEditorPane, setEditorTargetID} = useControlsContext()
                ...
                <tr key={book.id}>
                    ...
                    <td>
                        <OverlayTrigger
                            ...
                            >
                            <span className={`ms-auto me-2 ${book.notes.length > 0 ? "text-success" : "text-muted"}`}>
                    ...
                    <td>
                        <ButtonGroup className="d-flex justify-content-center ms-4 me-4">
                            <Button variant="outline-primary" size="sm" onClick={() => {setEditorTargetID(book.id); openEditorPane()}}>
